...
<body>
	...
	<div class="row">
  		...
  		<img src="WebPages/5G-Eve-logo.jpg" alt="5G Eve Logo" style="height:150px; display: block; margin-left: auto; margin-right: auto; margin-top:10px; margin-bottom: 2px"/>
    		...
    		<br>
			${message }
			<h3>Please select the image of PCL software:</h3>	
	
			<form method="POST" action="AGV">
				<input type="radio" name="newIntent" checked="checked" value="Image 1"/>Image 1
    			<input type="radio" name="newIntent" value="Image 2"/>Image 2
    			<input type="radio" name="newIntent" value="Image 3"/>Image 3
				<br><br>
