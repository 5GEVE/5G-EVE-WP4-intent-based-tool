...
<title>Connected Ambulance Data Rate</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Connected Ambulance Blueprint</h1>
    		<br>
    		${message }
			<h3>Please provide the expected data rate for the camera view:</h3>
	
			<form method="POST" action="ConnAmb">
				<input type="hidden" name="intent" value='${intent }'/>
				Data Rate:
				<input type="number" name="dataRate" min="1" step="1" value="100">Mbps<br><br>
