...
<title>Smart Home Number of Devices</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Smart Personalised Spaces Blueprint</h1>
    		<br>
    		${message }
			<h3>Please provide the number of devices:</h3>
	
			<form method="POST" action="SmrtHome">
				<input type="hidden" name="intent" value='${intent }'/>
				Number of devices:
				<input type="number" name="numOfDevs" min="1" step="1" value="1"><br><br>
