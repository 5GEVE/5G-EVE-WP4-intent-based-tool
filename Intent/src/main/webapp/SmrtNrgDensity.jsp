...
<title>Smart Energy Density</title>
...
<body>
	...
	<img src="WebPages/5G-Eve-logo.jpg" alt="5G Eve Logo" style="height:150px; display: block; margin-left: auto; margin-right: auto; margin-top:10px; margin-bottom: 2px"/>
			...
			<br>
			${message }
			<h3>Please provide the number of the devices/km2:</h3>
	
			<form method="POST" action="SmrtNrg">
				<input type="hidden" name="intent" value='${intent }'/>
				Number of devices/km2:
				<input type="number" name="numOfDevs" min="1" max="2000" step="1" value="1"><br><br>
