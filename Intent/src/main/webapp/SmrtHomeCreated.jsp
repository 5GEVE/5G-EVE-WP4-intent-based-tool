...
<title>Smart Home Bp Created</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		<h1>Smart Personalised Spaces Blueprint Created</h1>
	...
	<table border="1" align="center">
		...
		<br>
		<form method="POST" action="SmrtHome">
			<input type="hidden" name="guided" value="true"/>
			<input type="hidden" name="countryToChecked" value="${hom.country }"/>
			<input type="hidden" name="countryFromChecked" value="${hom.fromCountry }"/>
			<input type="hidden" name="numOfDevsChecked" value="${hom.numOfDevs }"/>
			<input type="hidden" name="dayChecked" value="${hom.day }"/>
			<input type="hidden" name="monthChecked" value="${hom.month }"/>
			<input type="hidden" name="yearChecked" value="${hom.year }"/>
			<input type="hidden" name="hourChecked" value="${hom.hour }"/>
			<input type="hidden" name="minutesChecked" value="${hom.minutes }"/>
			<input type="hidden" name="latencyChecked" value="${hom.latency }"/>
			<input type="hidden" name="dataRateChecked" value="${hom.dataRate }"/>
			<input type="hidden" name="reliabilityChecked" value="${hom.reliability }"/>
			<input type="hidden" name="availabilityChecked" value="${hom.availability }"/>
			<input type="hidden" name="mobilityChecked" value="${hom.mobility }"/>
			<input type="hidden" name="broadbandChecked" value="${hom.broadband }"/>
			<input type="hidden" name="capacityChecked" value="${hom.capacity }"/>
			<input type="hidden" name="densityChecked" value="${hom.density }"/>
			<input type="hidden" name="slicingChecked" value="${hom.slicing }"/>
			<input type="hidden" name="securityChecked" value="${hom.security }"/>
