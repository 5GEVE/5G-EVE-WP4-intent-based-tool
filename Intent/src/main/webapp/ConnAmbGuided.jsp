...
<title>Connected Ambulance Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Connected Ambulance Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="ConnAmb">
	<div class="row">
		...
		<input type="hidden" name="guided" value='true'/>
  		...
  		<div class="column" style="text-align: right">
    			...
    			<!-- <h3>Latency:</h3>
				<input type="number" name="latencyChecked" min="1" step="1" value="5">ms-->
  		</div>
  		...
  		<div class="column" style="text-align: left">
    			...
    			<!--<h3>Camera data rate:</h3>
				<input type="number" name="dataRateChecked" min="1" step="1" value="100">Mbps-->
 		 </div>
