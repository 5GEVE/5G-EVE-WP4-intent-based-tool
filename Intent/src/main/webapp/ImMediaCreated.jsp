...
<title>Immersive Media Bp Created</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		<h1>Immersive and Integrated Media Blueprint Created</h1>
	...
	<table border="1" align="center">
		...
		<tr>
			...
			<td><i>${med.day }/${med.month }/${med.year }</i>
		</tr>
		<tr>
		...
		<!-- <tr>
			...
			<td><i>${med.upLink }Mbps</i></td>
		</tr>
		<tr>
			<td><b>Allocated bandwidth per mobile cell</b></td>
			<td><i>${med.cellBand }Mbps</i></td>
		</tr> -->
		<tr>
			<td><b>Service</b></td>
		...
		<tr>
			<td><b>Latency</b></td>
			<td><i>${med.latency }ms</i></td>
		</tr>
		<tr>
			<td><b>Data Rate</b></td>
			<td><i>${med.dataRate }Mbps</i></td>
		</tr>
		<tr>
			<td><b>Reliability</b></td>
			<td><i>${med.reliability }%</i></td>
		</tr>
		<tr>
			<td><b>Availability</b></td>
			<td><i>${med.availability }%</i></td>
		</tr>
		<tr>
			<td><b>Broadband Connectivity</b></td>
			<td><i>${med.broadband }Mbps</i></td>
		</tr>
		<tr>
			<td><b>Capacity</b></td>
			<td><i>${med.capacity }Mbps/m2</i></td>
		</tr>
		<tr>
			<td><b>Device Density</b></td>
			<td><i>${med.density }Devices/Km2</i></td>
		</tr>
		<tr>
			<td><b>Network Slicing</b></td>
			<td><i>${med.slicing }</i></td>
		</tr>
		<tr>
			<td><b>Security</b></td>
		...
		<br>
		<form method="POST" action="ImMedia">
			<input type="hidden" name="guided" value="true"/>
			<input type="hidden" name="countryToChecked" value="${med.country }"/>
			<input type="hidden" name="countryFromChecked" value="${med.fromCountry }"/>
			<input type="hidden" name="upLinkChecked" value="${med.upLink }"/>
			<input type="hidden" name="cellBandChecked" value="${med.cellBand }"/>
			<input type="hidden" name="dayChecked" value="${med.day }"/>
			<input type="hidden" name="monthChecked" value="${med.month }"/>
			<input type="hidden" name="yearChecked" value="${med.year }"/>
			<input type="hidden" name="hourChecked" value="${med.hour }"/>
			<input type="hidden" name="minutesChecked" value="${med.minutes }"/>
			<input type="hidden" name="latencyChecked" value="${med.latency }"/>
			<input type="hidden" name="dataRateChecked" value="${med.dataRate }"/>
			<input type="hidden" name="reliabilityChecked" value="${med.reliability }"/>
			<input type="hidden" name="availabilityChecked" value="${med.availability }"/>
			<input type="hidden" name="mobilityChecked" value="${med.mobility }"/>
			<input type="hidden" name="broadbandChecked" value="${med.broadband }"/>
			<input type="hidden" name="capacityChecked" value="${med.capacity }"/>
			<input type="hidden" name="densityChecked" value="${med.density }"/>
			<input type="hidden" name="slicingChecked" value="${med.slicing }"/>
			<input type="hidden" name="securityChecked" value="${med.security }"/>
