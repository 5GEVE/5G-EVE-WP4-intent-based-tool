...
<title>Smart Energy Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Smart Energy Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="SmrtNrg">
	<div class="row">
		...
		<input type="hidden" name="guided" value='true'/>
  		...
  		<div class="column" style="text-align: right">
    			...
    			<input type="radio" name="countryToChecked" value="Greece"/>Greece
    			...
    			<!-- <h3>Number of devices/km2:</h3>
				<input type="number" name="numOfDevsChecked" min="1" max="2000" step="1" value="1">-->
  		</div>
  		...
  		<div class="column" style="text-align: left">
				...
				<!--<h3>Data Rate:</h3>
				<input type="number" name="dataRateChecked" min="0" step="0.5" value="50">Mbps-->
 		 </div>
