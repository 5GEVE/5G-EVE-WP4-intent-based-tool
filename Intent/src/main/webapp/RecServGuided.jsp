...
<title>Recognition Service Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Recognition Service Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="RecServ">
	<div class="row">
 	...
 	<div class="row" style="text-align: center">
		...
		<input type="number" name="numOfDevsChecked" min="1" max="300" step="1" value="1">
 		...
 		<h3>Make sure to have 5G EVE tracking service available and active!</h3>
