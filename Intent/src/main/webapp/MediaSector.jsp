...
<body>
	...
	<div class="row">
  		...
  		<img src="WebPages/5G-Eve-logo.jpg" alt="5G Eve Logo" style="height:150px; display: block; margin-left: auto; margin-right: auto; margin-top:10px; margin-bottom: 2px"/>
    		<h1>Media and Entertainment Sector</h1>
    		<br>
    		<h3>Please select the service you want to run:</h3>
	
			<form name="intentForm" method="POST" action="Expression">
				<input type="radio" name="intent" checked="checked" value=" immersive "/>Immersive and Integrated Media
				<input type="radio" name="intent" value=" on site "/>On-Site Live Event Experience
				<input type="radio" name="intent" value=" uhf "/>Ultra High-Fidelity Media
				<input type="radio" name="intent" value=" virtual 360 "/>Virtual Visit - Virtual 360
			<br><br>
