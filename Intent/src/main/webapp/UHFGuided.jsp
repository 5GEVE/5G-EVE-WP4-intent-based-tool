...
<title>Ultra High-Fidelity Media Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Ultra High-Fidelity Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="UHF">
	<div class="row">
 	...
 	<div class="row" style="text-align: center">
		...
		<input type="number" name="cellBandChecked" min="100" max="200" step="1" value="100">Mbps
