...
<body>
	...
	<img src="WebPages/5G-Eve-logo.jpg" alt="5G Eve Logo" style="height:150px; display: block; margin-left: auto; margin-right: auto; margin-top:10px; margin-bottom: 2px"/>
			<h1>Recognition Service Blueprint</h1>
			<br>
			${message }
			<h3>Please provide the number of the devices (smartphones):</h3>
	
			<form method="POST" action="RecServ">
				<input type="hidden" name="intent" value='${intent }'/>
				Number of Devices:
				<input type="number" name="numOfDevices" min="1" max="300" step="1" value="1"><br><br>
