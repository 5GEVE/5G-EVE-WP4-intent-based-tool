...
<title>Tracking Service Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Tracking Service Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="TrackServ">
	<div class="row">
 	...
 	<div class="row" style="text-align: center">
		...
		<input type="number" name="numOfDevsChecked" min="1" max="300" step="1" value="1">
 		...
 		<h3>Make sure to that the devices include the following sensors
			<ul>
				<li style="display: inline"><span>&#10022;</span>GPS   </li>
				<li style="display: inline"><span>&#10022;</span>Accelerometer   </li>
				<li style="display: inline"><span>&#10022;</span>Magnetometer   </li>
				<li style="display: inline"><span>&#10022;</span>Gyroscope   </li>
			</ul>
		</h3>
