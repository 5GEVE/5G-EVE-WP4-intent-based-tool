...
<title>Virtual Visit Bp Created</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		<h1>Virtual Visit Blueprint Created</h1>
	...
	<table border="1" align="center">
		...
		<form method="POST" action="Video360">
			...
			<input type="hidden" name="countryFromChecked" value="${video.fromCountry }"/>
			<input type="hidden" name="latencyChecked" value="${video.latency }"/>
			<input type="hidden" name="bandwidthChecked" value="${video.bandwidth }"/>
			<input type="hidden" name="dayChecked" value="${video.day }"/>
			<input type="hidden" name="monthChecked" value="${video.month }"/>
			<input type="hidden" name="yearChecked" value="${video.year }"/>
			<input type="hidden" name="hourChecked" value="${video.hour }"/>
			<input type="hidden" name="minutesChecked" value="${video.minutes }"/>
			<input type="hidden" name="latencyChecked" value="${video.latency }"/>
			<input type="hidden" name="dataRateChecked" value="${video.dataRate }"/>
			<input type="hidden" name="reliabilityChecked" value="${video.reliability }"/>
			<input type="hidden" name="availabilityChecked" value="${video.availability }"/>
			<input type="hidden" name="mobilityChecked" value="${video.mobility }"/>
			<input type="hidden" name="broadbandChecked" value="${video.broadband }"/>
			<input type="hidden" name="capacityChecked" value="${video.capacity }"/>
			<input type="hidden" name="densityChecked" value="${video.density }"/>
			<input type="hidden" name="slicingChecked" value="${video.slicing }"/>
			<input type="hidden" name="securityChecked" value="${video.security }"/>
