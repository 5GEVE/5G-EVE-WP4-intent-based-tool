...
<title>Business Augmented Booth Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Business Augmented Booth Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="BuisSmrtTrsm">
	<div class="row">
		...
		<input type="hidden" name="guided" value='true'/>
  		...
  		<div class="column" style="text-align: left">
				...
				<!--<h3>Bandwidth:</h3>
				<input type="number" name="bandwidthChecked" min="50" step="1" value="50">Mbps-->
 		 </div>
