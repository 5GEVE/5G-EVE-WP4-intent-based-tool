...
<title>Smart Turin Bp Created</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		<h1>Smart Turin Blueprint Created</h1>
	...
	<table border="1" align="center">
		...
		<br>
		<form method="POST" action="SmrtTurin">
			<input type="hidden" name="guided" value="true"/>
			<input type="hidden" name="countryToChecked" value="${tur.country }"/>
			<input type="hidden" name="countryFromChecked" value="${tur.fromCountry }"/>
			<input type="hidden" name="numOfDevsChecked" value="${tur.numOfDevs }"/>
			<input type="hidden" name="dayChecked" value="${tur.day }"/>
			<input type="hidden" name="monthChecked" value="${tur.month }"/>
			<input type="hidden" name="yearChecked" value="${tur.year }"/>
			<input type="hidden" name="hourChecked" value="${tur.hour }"/>
			<input type="hidden" name="minutesChecked" value="${tur.minutes }"/>
			<input type="hidden" name="latencyChecked" value="${tur.latency }"/>
			<input type="hidden" name="dataRateChecked" value="${tur.dataRate }"/>
			<input type="hidden" name="reliabilityChecked" value="${tur.reliability }"/>
			<input type="hidden" name="availabilityChecked" value="${tur.availability }"/>
			<input type="hidden" name="mobilityChecked" value="${tur.mobility }"/>
			<input type="hidden" name="broadbandChecked" value="${tur.broadband }"/>
			<input type="hidden" name="capacityChecked" value="${tur.capacity }"/>
			<input type="hidden" name="densityChecked" value="${tur.density }"/>
			<input type="hidden" name="slicingChecked" value="${tur.slicing }"/>
			<input type="hidden" name="securityChecked" value="${tur.security }"/>
