...
<title>Immersive Media Guided</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Immersive and Integrated Media Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="ImMedia">
	<div class="row">
		...
		<input type="hidden" name="guided" value='true'/>
  		...
  		<div class="column" style="text-align: right">
    			...
    			<input type="radio" name="countryToChecked" checked="checked" value="Spain"/>Spain
    			...
    			<!-- <h3>Allocated bandwidth per mobile cell:</h3>
				<input type="number" name="cellBandChecked" min="40" max="80" step="1" value="40">Mbps-->
  		</div>
  		...
  		<div class="column" style="text-align: left">
				...
				<!-- <h3>Uplink for each connected camera:</h3>
				<input type="number" name="upLinkChecked" min="2" max="10" step="1" value="2">Mbps-->
 		 </div>
