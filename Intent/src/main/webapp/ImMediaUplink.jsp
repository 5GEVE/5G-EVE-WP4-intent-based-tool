...
<title>Immersive Media Uplink</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<br>
    		${message }
			<h3>Please provide the expected Uplink for each camera connected:</h3>
	
			<form method="POST" action="ImMedia">
				<input type="hidden" name="intent" value='${intent }'/>
				Uplink:
				<input type="number" name="upLink" min="2" max="10" step="1" value="2">Mbps<br><br>
