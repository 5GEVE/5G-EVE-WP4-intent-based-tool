...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		...
    		<h1>Smart Personalised Spaces Guided Selection</h1>
    		<h2>Select the attributes you want your Blueprint to have</h2>	
  	</div>
	
	<form name="intentForm" method="POST" action="SmrtHome">
	<div class="row">
 	...
 	<div class="row" style="text-align: center">
		...
		<input type="number" name="numOfDevsChecked" min="1" step="1" value="1">
