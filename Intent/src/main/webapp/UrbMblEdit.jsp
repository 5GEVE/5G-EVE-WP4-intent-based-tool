...
<title>Urban Mobility Bp Edit</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		<h1>Urban Mobility Blueprint Edit</h1>
    		
    		<h3>${notAvailable }</h3>
    		<h3>${suggestion }</h3>
    		
    <form name="UrbanMobilityEdit" method="POST" action="UrbMbl">
	...
	<table border="1" align="center">
		...
		<tr>
			...
			<td><i><select name="countryFromChecked">
					<option selected hidden="{urb.fromCountry }">${urb.fromCountry }</option>
		...
		<tr>
			...
			<td><i>
				Day: <input type="number" name="dayChecked" min="1" max="31" step="1" value='${urb.day }'/>
				<br>Month: <input type="number" name="monthChecked" min="1" max="12" step="1" value='${urb.month }'/>
				<br>Year: <input type="number" name="yearChecked" min="2019" max="2100" step="1" value='${urb.year }'/>
			</i></td>
		</tr>
		<tr>
			<td><b>Time of Execution</b></td>
			<td><i>
				Hour: <input type="number" name="hourChecked" min="0" max="23" step="1" value='${urb.hour }'/>
				<br>Minutes: <input type="number" name="minutesChecked" min="0" max="59" step="1" value='${urb.minutes }'/>
			</i></td>
		</tr>
		<tr>
			<td><b>Number of Devices</b></td>
			<td><i><input type="number" name="numOfDevsChecked" min="1" max="300" step="1" value="${urb.numOfDevs }"></i></td>
		</tr>
		<tr>
			<td><b>Service</b></td>
		...
		<tr>
			<td><b>Latency</b></td>
			<td><i><input type="number" name="latencyChecked" min="1" max="5" step="1" value="${urb.latency }">ms</i></td>
		</tr>
		<tr>
			<td><b>Data Rate</b></td>
			<td><i><input type="number" name="dataRateChecked" min="40" max="100" step="1" value="${urb.dataRate }">Mbps</i></td>
		</tr>
		<tr>
			<td><b>Reliability</b></td>
			<td><i><input type="number" name="reliabilityChecked" min="99.95" max="99.999" step="0.001" value="${urb.reliability }">%</i></td>
		</tr>
		<tr>
			<td><b>Availability</b></td>
			<td><i><input type="number" name="availabilityChecked" min="90" max="99.99" step="0.01" value="${urb.availability }">%</i></td>
		</tr>
		<tr>
			<td><b>Mobility</b></td>
			<td><i><input type="number" name="mobilityChecked" min="260" max="300" step="1" value="${urb.mobility }">Km/h</i></td>
		</tr>
		<tr>
			<td><b>Broadband Connectivity</b></td>
			<td><i><input type="number" name="broadbandChecked" min="1600" max="10000" step="1" value="${urb.broadband }">Mbps</i></td>
		</tr>
		<tr>
			<td><b>Capacity</b></td>
			<td><i><input type="number" name="capacityChecked" min="1" max="5" step="0.01" value="${urb.capacity }">Mbps/m2</i></td>
		</tr>
		<tr>
			<td><b>Device Density</b></td>
			<td><i><input type="number" name="densityChecked" min="100000" max="1000000" step="1" value="${urb.density }">Devices/Km2</i></td>
		</tr>
		<tr>
