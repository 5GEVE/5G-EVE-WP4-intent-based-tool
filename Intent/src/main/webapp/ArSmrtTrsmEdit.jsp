...
<title>AR Interaction Bp Edit</title>
...
<body>
	...
	<div class="row">
  		<div class="columnCreated">
    		<h1>AR Interaction Blueprint Edit</h1>
    		
    		<h3>${notAvailable }</h3>
    		<h3>${suggestion }</h3>
    		
    <form name="ArSmrtTrsmEdit" method="POST" action="ArSmrtTrsm">
	...
	<table border="1" align="center">
		...
		<tr>
			...
			<td><i><select name="countryFromChecked">
					<option selected hidden="{trsm.fromCountry }">${trsm.fromCountry }</option>
		...
		<tr>
			...
			<td><i>
				Day: <input type="number" name="dayChecked" min="1" max="31" step="1" value='${trsm.day }'/>
				<br>Month: <input type="number" name="monthChecked" min="1" max="12" step="1" value='${trsm.month }'/>
				<br>Year: <input type="number" name="yearChecked" min="2019" max="2100" step="1" value='${trsm.year }'/>
			</i></td>
		</tr>
		<tr>
			<td><b>Time of Execution</b></td>
			<td><i>
				Hour: <input type="number" name="hourChecked" min="0" max="23" step="1" value='${trsm.hour }'/>
				<br>Minutes: <input type="number" name="minutesChecked" min="0" max="59" step="1" value='${trsm.minutes }'/>
			</i></td>
		</tr>
		<!-- <tr>
			<td><b>Latency</b></td>
			<td><i><input type="number" name="latencyChecked" min="1" max="200" step="1" value="${trsm.latency }">ms</i></td>
		</tr>
		<tr>
			<td><b>Bandwidth</b></td>
			<td><i><input type="number" name="bandwidthChecked" min="50" step="1" value="${trsm.bandwidth }">Mbps</i></td>
		</tr> -->
		<tr>
			<td><b>Service</b></td>
		...
		<tr>
			<td><b>Latency</b></td>
			<td><i><input type="number" name="latencyChecked" min="100" max="200" step="1" value="${trsm.latency }">ms</i></td>
		</tr>
		<tr>
			<td><b>Data Rate</b></td>
			<td><i><input type="number" name="dataRateChecked" min="1" max="100" step="1" value="${trsm.dataRate }">Mbps</i></td>
		</tr>
		<tr>
		...
		<tr>
			<td><b>Mobility</b></td>
			<td><i>${trsm.mobility }Km/hour</i></td>
		</tr>
		<tr>
			<td><b>Broadband Connectivity</b></td>
			<td><i><input type="number" name="broadbandChecked" min="500" max="30000" step="1" value="${trsm.broadband }">Mbps</i></td>
		</tr>
		<tr>
			<td><b>Capacity</b></td>
			<td><i><input type="number" name="capacityChecked" min="0.3125" max="18.75" step="0.0001" value="${trsm.capacity }">Mbps/m2</i></td>
		</tr>
		<tr>
			<td><b>Device Density</b></td>
			<td><i>${trsm.density }Deices/Km2</i></td>
		</tr>
		<tr>
			<td><b>Network Slicing</b></td>
			<td><i><select name="slicingChecked">
				<option selected hidden="{trsm.slicing }">${trsm.slicing }</option>
